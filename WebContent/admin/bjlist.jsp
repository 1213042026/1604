  ...
  function frist()
		{
		 	with (document.getElementById("memberForm")) {
	            method = "post";
	            action = "<%=path %>/bjmana.action?index=1";
	            submit();
	        }
		}
		...
		function back()
		{
		    ...
		    if(pageNo<2){
		 	   ...
		 	   pageNo=Number(pageNo)-1;
				 ...
				 with (document.getElementById("memberForm")) {
			            method = "post";
			             action = "<%=path %>/bjmana.action?index="+pageNo;
			            submit();
			        }
		}
		...
		{ 
		   var totlePage='<%=totlePage%>';
			with (document.getElementById("memberForm")) {
	            method = "post";
	            action = "<%=path %>/bjmana.action?index="+totlePage;
	            submit();
	        }
		}
		...
		function add(){
			...
			window.location.href="<%=path%>/admin/bjadd.jsp";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr class="line_g hover_bg">
    ...
    <td width="10%" align="center"><strong>品牌名称</strong></td>
    <td width="10%" align="center"><strong>品牌车辆数</strong></td>
  ...
  <tr class="line_g hover_bg">
    ...
    <td align="center"><%=bean.getNums() %></td>
