...
<table id="sample-table-1" class="table">
  ...
  <tr>
    <td>车号：</td>
    <td><input type="text" id="no" name="no" value="<%=bean.getNo() %>"/></td>
  </tr>
  <tr>
    <td>车名：</td>
    <td><input type="text" id="stuname" name="stuname" value="<%=bean.getStuname() %>"/></td>
  </tr>
   <tr>
    <td>级别：</td>
    <td>
     <select class="form-control" id="jzname" name="jzname">
   ...
   <tr>
    <td>价格：</td>
    <td><input type="text" id="tel" name="tel" value="<%=bean.getTel() %>"/></td>
  </tr>
   <tr>
    <td>排量：</td>
    <td ><input type="text" id="address" name="address" value="<%=bean.getAddress() %>"/></td>
  </tr>
   <tr>
    <td>预约开始时间：</td>
    <td><input type="text" id="bt" name="bt" value="<%=bean.getBt() %>"/></td>
  </tr>
   <tr>
    <td>预约结束时间：</td>
    <td><input type="text" id="et" name="et" value="<%=bean.getEt() %>"/></td>
  </tr>
   <tr>
    <td>图片：</td>
  ...
  <tr>
    ...
    <textarea style="resize: none;"  rows="20" cols="80" id="dw" name="dw"><%=bean.getDw() %></textarea>
    </td>
  </tr>
  <tr class="line_g">
