...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr class="line_g">
    ...
    <td width="90%" class="jianju20"><input type="text" id="stuname" name="stuname" class="text width300" /></td>
  </tr>
   <tr class="line_g">
   ...
   <tr class="line_g">
    ...
    <td width="90%" class="jianju20"><input type="text" id="address" name="address" class="text width300" /></td>
  </tr>
   <tr class="line_g">
    <td width="10%" class="jianju10">预约开始时间：</td>
    <td width="90%" class="jianju20"><input type="text" id="bt" name="bt" class="text width300" /></td>
  </tr>
   <tr class="line_g">
    <td width="10%" class="jianju10">预约结束时间：</td>
    <td width="90%" class="jianju20"><input type="text" id="et" name="et" class="text width300" /></td>
  </tr>
   <tr class="line_g">
  ...
  <tr class="line_g">
    ...
    <textarea rows="20" cols="50" id="dw" name="dw"></textarea>
    </td>
  </tr>
  <tr class="line_g">
    <td colspan="2">
