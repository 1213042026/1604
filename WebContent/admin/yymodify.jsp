...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	Yy bean = (Yy)request.getAttribute("bean");
%>
...
<div class="infolist">
<form method="post" action="<%=path %>/yymodify.action" method="post" name="ThisForm" >
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr class="line_g">
    ...
    <td width="90%" class="jianju20"><input type="text" id="times" name="times" class="text width300" value="<%=bean.getTimes() %>" onClick="SelectDate(this.name)"/></td>
  </tr>
  
    <tr class="line_g">
    <td width="10%" class="jianju10">备注：</td>
    <td width="90%" class="jianju20">
    <textarea rows="20" cols="50" id="descs" name="descs"><%=bean.getDescs() %></textarea>
