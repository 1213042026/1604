...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <ul class="zsgc fleft">
      ...
      <li><a href="#" onclick="modify()">修改</a></li> 
    </ul>
  ...
  <tr class="line_g hover_bg">
    ...
    <td width="9%" align="center"><strong>车号</strong></td>
    <td width="9%" align="center"><strong>车名</strong></td>
    <td width="9%" align="center"><strong>品牌</strong></td>
    <td width="10%" align="center"><strong>图片</strong></td>
    <td width="9%" class="jianju10"><strong>级别</strong></td>
    <td width="9%" align="center"><strong>价格</strong></td>
    <td width="12%" align="center"><strong>排量</strong></td>
    <td width="12%" align="center"><strong>开始预约</strong></td>
    <td width="9%" align="center"><strong>结束预约</strong></td>
     <td width="9%" align="center"><strong>描述</strong></td>
  </tr>
